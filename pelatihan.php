        ...
        <div class="p-6">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-4">
                <div>
                  <label for="nama" class="block text-sm font-medium text-gray-700">Nama Pelatihan*</label>
              ...
              <div class="space-y-4">
                <div>
                  <label for="date" class="block text-sm font-medium text-gray-700">Tanggal Pelatihan*</label>
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <form method="post">
          ...
          <div class="mb-4">
            <label for="edit_farmer_id" class="block text-sm font-medium text-gray-700">Petani*</label>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <label for="edit_nama" class="block text-sm font-medium text-gray-700">Nama Peserta*</label>
    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            <label for="type" class="block text-sm font-medium text-gray-700">Tipe Narasumber*</label>

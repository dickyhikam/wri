...
<head>
    ...
    <title>Code OTP - WRI Indonesia</title>
...
<body class="relative min-h-screen flex flex-col items-center justify-center font-sans px-4">
    ...
    <script>
        ...
        const userEmail = "<?= $_SESSION['email'] ?>"; // Replace with actual email
        const userRole = "<?= $_SESSION['role'] == 'User' ? 'index-user' : 'index'; ?>"; // Replace with actual email

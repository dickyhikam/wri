      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
        ...
        <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
          <div class="flex-1 flex justify-between sm:hidden">
            <a href="kelompok_tani.php?<?= http_build_query(array_merge($_GET, ['page' => max(1, $currentPage - 1)])) ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 <?= $currentPage <= 1 ? 'opacity-50 cursor-not-allowed' : '' ?>">
              Sebelumnya
            </a>
            <a href="kelompok_tani.php?<?= http_build_query(array_merge($_GET, ['page' => min($totalPages, $currentPage + 1)])) ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 <?= $currentPage >= $totalPages ? 'opacity-50 cursor-not-allowed' : '' ?>">
              Selanjutnya
            </a>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div>
              ...
              <div class="space-y-2">
                ...
                <p class="text-sm"><span class="font-medium">Total Aktivitas:</span> <?= count(array_filter($dummyActivities, function($a) use ($group_id) { return $a['group_id'] == $group_id; })) ?> kegiatan</p>
              </div>
            </div>
                      ...
                      <?php foreach ($groupActivities as $activity): ?>
                        <tr>
                          ...
                          <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="kelompok_tani.php?action=edit_activity&id=<?= $activity['activity_id'] ?>" class="text-blue-600 hover:text-blue-800 mr-3" title="Edit">
                              <i class="fas fa-edit"></i>
                            </a>
                    ...
                    <?php else: ?>
                      <?php foreach ($groupMembers as $index => $m): ?>
                        <tr>
                          ...
                          <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="kelompok_tani.php?action=edit_member&id=<?= $m['member_id'] ?>" class="text-blue-600 hover:text-blue-800 mr-3" title="Edit">
                              <i class="fas fa-edit"></i>
                            </a>
...
<script>
  ...
  function confirmDelete(groupId) {
    if (confirm('Apakah Anda yakin ingin menghapus kelompok tani ini?')) {
      window.location.href = 'kelompok_tani.php?action=delete&id=' + groupId;
    }
  }
  ...
  function confirmDeleteActivity(activityId) {
    if (confirm('Apakah Anda yakin ingin menghapus aktivitas ini?')) {
      window.location.href = 'kelompok_tani.php?action=delete_activity&id=' + activityId;
    }
  }
  ...
  function confirmDeleteMember(memberId) {
    if (confirm('Apakah Anda yakin ingin menghapus anggota ini?')) {
      window.location.href = 'kelompok_tani.php?action=delete_member&id=' + memberId;
    }
  }
</script>

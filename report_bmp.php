...
<section class="flex-1 overflow-y-auto p-8 bg-gray-50">
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mb-6">
        <h3 class="text-lg font-semibold mb-4">Filter Laporan BMP</h3>
            ...
            <div class="col-span-4">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <label class="flex items-center">
                        ...
                        <span class="ml-2">Jenis BMP</span>
                    </label>
                    <label class="flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mb-6">
        <div class="flex justify-between items-center mb-4">
            <h3 class="font-semibold text-lg">Daftar BMP</h3>
            <div class="space-x-2">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="reportBMPTableBody">
            </table>
        </div>
    </div>
...
<script>
    ...
    function renderReportTable(filtered) {
        const tableBody = document.getElementById('reportBMPTableBody');
        tableBody.innerHTML = `
            <thead>
                <tr class="bg-gray-50">
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase jenis">Jenis BMP</th>

...
<section class="flex-1 overflow-y-auto p-8 bg-gray-50">
  ...
  $dummyKategori = [
      'Terjatuh', 'Tertimpa', 'Terpotong', 'Tertusuk', 'Terkena Benda Tajam',
      'Kontak Listrik', 'Paparan Kimia', 'Gigitan Hewan', 'Kebakaran',
      'Kecelakaan Transportasi', 'Ergonomi', 'Lainnya'
  ];

  $dummyTindakan = [
      'Pertolongan Pertama', 'Rujuk ke Puskesmas', 'Rujuk ke Rumah Sakit',
      'Evakuasi', 'Perawatan di Klinik', 'Lainnya'
  ];
                ...
                <div class="p-6">
                    ...
                    <form method="post">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    <label for="farmer_gr_id" class="block text-sm font-medium text-gray-700 mb-1">Grup Petani*</label>
                                ...
                                <div class="mb-4">
                                    <label for="periode" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kejadian*</label>
                                    <input type="date" id="periode" name="periode" class="w-full px-3 py-2 border border-gray-300 rounded-lg" required>
                                </div>
                                <div class="mb-4">
                                    <label for="jumlah_korban" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Korban*</label>
                            ...
                            <div>
                                <div class="mb-4">
                                    <label for="lokasi_utama" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Utama*</label>
                                ...
                                <div class="mb-4">
                                    <label for="kategori_utama" class="block text-sm font-medium text-gray-700 mb-1">Kategori Utama*</label>
                            ...
                            <div id="victim-details-container">
                                ...
                                <div id="victim-template" class="victim-entry mb-6 p-4 border border-dashed border-gray-300 rounded-lg hidden">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="type_user_1" class="block text-sm font-medium text-gray-700 mb-1">Tipe Pengguna*</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="nama_1" class="block text-sm font-medium text-gray-700 mb-1">Nama Korban*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="lokasi_kejadian_1" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Spesifik*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="kerugian_1" class="block text-sm font-medium text-gray-700 mb-1">Kerugian/Dampak*</label>
                                ...
                                <div class="victim-entry mb-6 p-4 border border-gray-200 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="type_user_0" class="block text-sm font-medium text-gray-700 mb-1">Tipe Pengguna*</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="nama_0" class="block text-sm font-medium text-gray-700 mb-1">Nama Korban*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="lokasi_kejadian_0" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Spesifik*</label>
                                        ...
                                        <div>
                                            <label for="kategori_0" class="block text-sm font-medium text-gray-700 mb-1">Kategori*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="kerugian_0" class="block text-sm font-medium text-gray-700 mb-1">Kerugian/Dampak*</label>
                ...
                <div class="p-6">
                    ...
                    <form method="post">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    <label for="edit_farmer_gr_id" class="block text-sm font-medium text-gray-700 mb-1">Grup Petani*</label>
                                ...
                                <div class="mb-4">
                                    <label for="edit_periode" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kejadian*</label>
                                ...
                                <div class="mb-4">
                                    <label for="edit_jumlah_korban" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Korban*</label>
                            ...
                            <div>
                                <div class="mb-4">
                                    <label for="edit_lokasi_utama" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Utama*</label>
                                ...
                                <div class="mb-4">
                                    <label for="edit_kategori_utama" class="block text-sm font-medium text-gray-700 mb-1">Kategori Utama*</label>
                                ...
                                <div class="mb-4">
                                    <label for="edit_tindakan" class="block text-sm font-medium text-gray-700 mb-1">Tindakan*</label>
                        ...
                        <div class="mt-6 border-t pt-6">
                            ...
                            <div id="edit-victim-details-container">
                                ...
                                <div id="edit-victim-template" class="victim-entry mb-6 p-4 border border-dashed border-gray-300 rounded-lg hidden">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="edit_type_user_1" class="block text-sm font-medium text-gray-700 mb-1">Tipe Pengguna*</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="edit_nama_1" class="block text-sm font-medium text-gray-700 mb-1">Nama Korban*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="edit_lokasi_kejadian_1" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Spesifik*</label>
                                        ...
                                        <div>
                                            <label for="edit_kategori_1" class="block text-sm font-medium text-gray-700 mb-1">Kategori*</label>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                        <div>
                                            <label for="edit_kerugian_1" class="block text-sm font-medium text-gray-700 mb-1">Kerugian/Dampak*</label>
                                ...
                                <?php foreach ($incident['korban'] as $index => $korban): ?>
                                    <div class="victim-entry mb-6 p-4 border border-gray-200 rounded-lg">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                            <div>
                                                <label for="edit_type_user_<?= $index ?>" class="block text-sm font-medium text-gray-700 mb-1">Tipe Pengguna*</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="edit_nama_<?= $index ?>" class="block text-sm font-medium text-gray-700 mb-1">Nama Korban*</label>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                            <div>
                                                <label for="edit_lokasi_kejadian_<?= $index ?>" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Spesifik*</label>
                                            ...
                                            <div>
                                                <label for="edit_kategori_<?= $index ?>" class="block text-sm font-medium text-gray-700 mb-1">Kategori*</label>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                            <div>
                                                <label for="edit_kerugian_<?= $index ?>" class="block text-sm font-medium text-gray-700 mb-1">Kerugian/Dampak*</label>

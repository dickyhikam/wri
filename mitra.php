...
<script>
  ...
  let mitraMillsData = [{
      id: 1,
      name: 'PT Sawit Maju Sejahtera',
      parent_company: 'PT Agro Sejahtera',
      kapasitas: 1200,
      location: 'Desa Bukit Kapur, Kec. Bukit Kapur, Kab. Dumai',
      status: 'Aktif'
    },
    {
      id: 2,
      name: 'PT Palma Andalas',
      parent_company: 'PT Palma Group',
      kapasitas: 900,
      location: 'Desa Sungai Apit, Kec. Sungai Apit, Kab. Siak',
      status: 'Aktif'
    },
    {
      id: 3,
    ...
    {
      id: 6,
      name: 'PT Bumi Pratama Khatulistiwa',
      parent_company: 'Lainnya',
      kapasitas: 800,
      location: 'Inhu, Riau',
      status: 'Aktif'
    },
  ...
  let mitraPengepulData = [{
      id: 1,
      kode: 'P001',
      name: 'UD Tani Barokah',
      location: 'Desa Air Molek, Kec. Pasir Penyu, Kab. Inhu',
      area_wilayah: 'Wilayah 3',
      status: 'Aktif'
    },
    {
      id: 2,
      ...
      location: 'Desa Pangkalan Pisang, Kec. Koto Gasib, Kab. Siak',
      area_wilayah: 'Wilayah 1',
      status: 'Tidak Aktif'
    },
    {
      id: 3,
  ...
  function openMillsModal(id = null) {
    ...
    // Initialize the map
    var map = L.map('map').setView([0.5173938881754586, 101.44717970593946], 5);
    ...
    var marker = L.marker([0.5173938881754586, 101.44717970593946], {
      draggable: true
    }).addTo(map);
    marker.bindPopup("Geser marker untuk merubah lokasi").openPopup();

    // Update hidden input on marker drag end
    ...
    // Update popup content and input fields on map click
    map.on('click', function(e) {
      var latlng = e.latlng;
      marker.setLatLng(latlng).update();
      document.getElementById('lat').value = latlng.lat;
      document.getElementById('lng').value = latlng.lng;
      marker.bindPopup("Selected Location: Lat: " + latlng.lat.toFixed(5) + ", Lng: " + latlng.lng.toFixed(5)).openPopup();
    });
  }
